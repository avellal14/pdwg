...
parser.add_argument('--restore_dir', type=str, default='/ad967480d54949f78afbc2473d9be87f/', help='Directory of restore experiment.')
...
parser.add_argument('--seed', type=int, default=1123125, help='random seed')
