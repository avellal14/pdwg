...
if Algorithm == 'RNF':
    alg_specific_settings = {'optimizer_class': 'Adam', 'learning_rate': 1e-6, 'beta1': 0.9, 'beta2': 0.999,  
                             'rel_enc_skip_rate': 1, 'rel_cri_skip_rate': 1, 'rel_gen_skip_rate': 1, 'n_filter': 256, 'n_flat': 400, 
...
parser.add_argument('--restore_dir', type=str, default='/219526da693941a2b243d3953f88dd67/', help='Directory of restore experiment.')
