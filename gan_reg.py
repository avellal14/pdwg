...
if Algorithm == 'WAE':
    ...
    alg_specific_settings = {'optimizer_class': 'Adam', 'learning_rate': 1e-4, 'beta1': 0.9, 'beta2': 0.999,  
                             ...
                             # 'enc_reg_strength': 10, 'enc_inv_MMD_n_reflect': 1, 'enc_inv_MMD_n_trans': 1, 'enc_inv_MMD_strength': 0.2, # CIFAR
...
parser.add_argument('--restore_dir', type=str, default='/868875d01513463086b63d16dc4ec6f5/', help='Directory of restore experiment.')
