...
if Algorithm == 'WAE':
    ...
    alg_specific_settings = {'optimizer_class': 'Adam', 'learning_rate': 1e-4, 'beta1': 0.9, 'beta2': 0.999,  
                             ...
                             'enc_normalization_mode': 'Layer Norm', 'gen_normalization_mode': 'Layer Norm', 'cri_normalization_mode': 'None', 
                             'enc_reg_strength': 50, 'enc_inv_MMD_n_reflect': 1, 'enc_inv_MMD_n_trans': 1, 'enc_inv_MMD_strength': 0.75, 
...
parser.add_argument('--save_checkpoints_epoch_rate', type=list, default=[100,1], help='epoch rate for storing checkpoints')
parser.add_argument('--restore_dir', type=str, default='/ae4660b3bb394473a7996ca415826817/', help='Directory of restore experiment.')
