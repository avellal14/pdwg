...
if Algorithm == 'RNF':
    alg_specific_settings = {'optimizer_class': 'Adam', 'learning_rate': 1e-4, 'beta1': 0.9, 'beta2': 0.999,  
                             ...
                             # 'critic_reg_mode': [], 'cri_reg_strength': 0.005, 'lambda_mix': 0, 'timers': {}, 'rnf_prop': {'n_input_CPO': 10, 'n_output_CPO': 10}}
                             'critic_reg_mode': [], 'cri_reg_strength': 0.001, 'lambda_mix': 0, 'timers': {}, 'rnf_prop': {'n_input_CPO': 10, 'n_output_CPO': 10}}
elif Algorithm == 'WAE':
