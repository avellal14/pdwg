...
z = tf.layers.dense(inputs = layer_3, units = latent_dim, use_bias = True, activation = None)
...
x_rec = tf.layers.dense(inputs = layer_3_rec, units = input_dim*tile_rate, use_bias = True, activation = None)
