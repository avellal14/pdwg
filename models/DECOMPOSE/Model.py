...
# import models.PDWGANCannon.ModelMapsDCGAN3 as ModelMaps
# import models.WGANGP.ModelMapsDCGAN3 as ModelMaps
import models.DECOMPOSE.ModelMapsDCGAN3 as ModelMaps
...
class Model():
    ...
    def inference(self, batch, additional_inputs_tf):
        ...
        self.decomposition_out, self.deterioration_out, self.decomposition_concat_out, self.deterioration_concat_out, self.reconstruction_cost = self.Encoder.forward(self.input_sample['image'], noise=None)

        self.interpolated_obs = {'flat': None, 'image': tf.concat([self.deterioration_out, self.decomposition_out], axis=1)} 
