...
class Model():
    ...
    def generate_modules(self, batch):
        # self.PriorMap = ModelMaps.PriorMapUniform(self.config)
        self.PriorMap = ModelMaps.PriorMapBeta(self.config)
        self.PriorMapBetaInverted = ModelMaps.PriorMapBetaInverted(self.config)
        self.AmbientMap = ModelMaps.AmbientMap(self.config)
